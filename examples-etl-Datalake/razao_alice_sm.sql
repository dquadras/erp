...
(
	...
	left join {{ source('cleaned_totvs', 'ct1030') }} ct1 on temp.conta_contabil = ct1.ct1_conta
	and ct1.d_e_l_e_t_ = ''
	...
	and ctt.d_e_l_e_t_ = ''
	left join {{ source('cleaned_totvs', 'sf1030') }} sf1 on substring(temp.ct2_key, 1, 22) = sf1.f1_filial + sf1.f1_doc + sf1.f1_serie + sf1.f1_fornece + sf1.f1_loja
	and sf1.d_e_l_e_t_ = ''
	left join {{ source('cleaned_totvs', 'se2030') }} se2 on substring(temp.ct2_key, 1, 22) = se2.e2_filial + se2.e2_num + se2.e2_prefixo + se2.e2_fornece + se2.e2_loja
	and e2_tipo = 'nf'
	and se2.d_e_l_e_t_ = ''
